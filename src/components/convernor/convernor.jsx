...
export default function Convernor(){
  const data=[
    ...
    },
    {
      head: "Co-Patrons",
      person: [
        {name:"Prof. Yashwardhan Soni", title:"Academic Administrator, DCE", img: yashwardhan},
      ]
    },
    {
      head: "Chief Person",
    ...
    },
    {
      ...
      person: [
        {name:"Dr. Ashima Mehta", title:"HOD, DCE", img: ashima},
      ]
    },
    {
      head: "Convenor",
      person: [
        {name:"Dr. Manoj Kumar", title:"Assistant Professor, DCE", img: manoj},
        {name:"Ms Renu Narwal", title:"Assistant Professor, DCE", img: renu},
      ]
    },
    {
